...
function preload() {
    ...
    background_music = loadSound('assets/sounds/background-music.mp3'); // connect sound from directory
    death_se = loadSound('assets/sounds/death-se.mp3');
    kill_se = loadSound('assets/sounds/kill-se.wav');
    backPlay = true;
}
